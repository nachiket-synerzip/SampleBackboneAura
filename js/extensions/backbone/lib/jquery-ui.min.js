...
(function (a, b) {
    ...
    }}), a.extend(a.ui.draggable, {version: "@VERSION"}), a.ui.plugin.add("draggable", "connectToSortable", {start: function (b, c) {
    ...
    }}), a.extend(a.ui.droppable, {version: "@VERSION"}), a.ui.intersect = function (b, c, d) {
    ...
    }}), a.extend(a.ui.resizable, {version: "@VERSION"}), a.ui.plugin.add("resizable", "alsoResize", {start: function (b, c) {
    ...
    }}), a.extend(a.ui.selectable, {version: "@VERSION"})
}(jQuery), function (a, b) {
    ...
    }}), a.extend(a.ui.sortable, {version: "@VERSION"})
    ...
    }}), a.extend(a.ui.accordion, {version: "@VERSION", animations: {slide: function (b, c) {
    ...
    }}), a.extend(a.ui.dialog, {version: "@VERSION", uuid: 0, maxZ: 0, getTitleId: function (a) {
        var b = a.attr("id");
    ...
    }}), a.extend(a.ui.progressbar, {version: "@VERSION"})
}(jQuery), function (a, b) {
    var c = 5;
    ...
    }}), a.extend(a.ui.tabs, {version: "@VERSION"}), a.extend(a.ui.tabs.prototype, {rotation: null, rotate: function (a, b) {
